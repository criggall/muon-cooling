...
if plot_option == 0:
    ...
    imageio.mimsave(fig_dir+'B_animation_full_channel.gif', B_images, duration=frame_duration, loop=0)
    imageio.mimsave(fig_dir+'residual_animation_full_channel.gif', residual_images, duration=frame_duration, loop=0)
else:
    imageio.mimsave(fig_dir+f'xy_animation_period_{plot_option}.gif', xy_images, duration=frame_duration, loop=0)
    imageio.mimsave(fig_dir+f'B_animation_period_{plot_option}.gif', B_images, duration=frame_duration, loop=0)
    imageio.mimsave(fig_dir+f'residual_animation_period_{plot_option}.gif', residual_images, duration=frame_duration, loop=0)
...
plt.ylabel('residual')
plt.legend()
plt.savefig(fig_dir+'residual_vs_p.png',dpi=300)